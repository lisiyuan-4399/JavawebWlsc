...
<script type="text/javascript">
		...
		function changeVarifyCode(obj) {
			$(obj).attr("src","${pageContext.request.contextPath }/checkImg?date="+Date());
		}
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<form id="registerForm" method="post"  class="form-horizontal" style="margin-top: 5px;" action="${pageContext.request.contextPath }/user?method=userRegister">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" placeholder="请输入验证码" name="varifyCode" id="varifyCode">
